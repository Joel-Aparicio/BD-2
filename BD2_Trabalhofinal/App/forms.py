...
class P_JogoForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        print("Clean method - cleaned data:", cleaned_data)
        return cleaned_data
    ...
    class Meta:
        model = P_Jogo
        fields = ['dia', 'competicao', 'estadio', 'clube_casa', 'equipa_casa', 'clube_fora', 'equipa_fora', 'estado', 'duracao', 'prolongamento', 'penaltis']
        widgets = {
